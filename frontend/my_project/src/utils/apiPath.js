export const BASE_URL = "https://guvii-project-backend.onrender.com/";
...
export const API_PATHS = {
  ...
  AI: {
    ...
    GENERATE_EXPLANATION: "/api/ai/generate-explanation", // Generate concept exp
  },
  ...
  Question: {
    ...
    UPDATE_NOTE: (id) => `/api/questions/${id}/note`, // Update/Add a note to a qu
  },
};
